...
//       time: { value: string };
//     };
//     const principal = parseFloat(target.principal.value)
//     const rate = parseFloat(target.rate.value) / 100 / 12
//     const time = parseFloat(target.time.value) * 12
//     const emi = (principal * rate * Math.pow(1 + rate, time)) / (Math.pow(1 + rate, time) - 1)
//     setEmiResult(parseFloat(emi.toFixed(2)))
//   }
...
//     };
//     const assets = parseFloat(target.assets.value)
//     const liabilities = parseFloat(target.liabilities.value)
//     const netWorth = assets - liabilities
//     setNetWorthResult(parseFloat(netWorth.toFixed(2)))
//   }
...
//                 Principal Amount
//               </label>
//               <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="principal" type="number" required />
//             </div>
//             <div className="mb-4">
//               <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="rate">
//                 Interest Rate (%)
//               </label>
//               <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="rate" type="number" step="0.01" required />
//             </div>
//             <div className="mb-4">
//               <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="time">
//                 Time (in years)
//               </label>
//               <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="time" type="number" required />
//             </div>
...
//                 Total Assets
//               </label>
//               <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="assets" type="number" required />
//             </div>
//             <div className="mb-4">
//               <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="liabilities">
//                 Total Liabilities
//               </label>
//               <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="liabilities" type="number" required />
//             </div>
//             <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
//               Calculate Net Worth
//             </button>
...
export default function Calculator() {
  ...
  const calculateSIP = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const monthly = parseFloat(target.monthly.value)
    const rate = parseFloat(target.rate.value) / 100 / 12
    const years = parseFloat(target.years.value)
    const n = years * 12
    const sip = monthly * ((Math.pow(1 + rate, n) - 1) / rate) * (1 + rate)
    setSipResult(parseFloat(sip.toFixed(2)))
  }
  ...
  const calculateFD = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const principal = parseFloat(target.principal.value)
    const rate = parseFloat(target.rate.value) / 100
    const time = parseFloat(target.time.value)
    const fd = principal * Math.pow(1 + rate, time)
    setFdResult(parseFloat(fd.toFixed(2)))
  }
        ...
        {activeCalculator === 'sip' && (
          <form onSubmit={calculateSIP}>
            <div className="mb-4">
              ...
              <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="monthly" type="number" required />
            </div>
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="rate">
            ...
            <div className="mb-4">
              ...
              <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="years" type="number" required />
            </div>
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
              Calculate SIP
            </button>
